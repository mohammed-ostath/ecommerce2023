                    ...
                    <div style="border-radius: 50%;" class=" col-lg-8 col-md-8 bg-white">
                        <div class="mb-30 d-flex align-items-center login-fancy pb-40 clearfix flex items-center justify-center mt-4">
                            <button>
                                ...
                                <span></span>
                                <span></span>
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30 d-flex align-items-center"><a href="{{route('login.show','costomer')}}"  class="btn btn-primary">

                                    costomer
                            </a></h3>
                            </button>
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-12" title="costomer" href="{{route('login.show','costomer')}}">
